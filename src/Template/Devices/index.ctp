                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                ...
                                if (isset($action) && $action == 'index') {
                                    ...
                                    <a href="<?php echo $this->Url->build(['controller' => 'Devices', 'action' => 'load_device_no_langdingpage']) ?>" >THIẾT BỊ CHƯA XÉT QUẢNG CÁO</a>
                                <li role="presentation">
                                    <a href="<?php echo $this->Url->build(['controller' => 'Devices', 'action' => 'load_device_has_langdingpage']) ?>" >THIẾT BỊ ĐÃ XÉT QUẢNG CÁO</a>
                                </li>
                            </ul>
