        ...
        <div id="fullpage">
            <div class="section" id="section1">
                <?php foreach ($list_path as $k => $vl) { ?>
                    <div class="slide" id="slide<?php echo $k + 1; ?>"
                         style="background-image: url('/<?php echo $vl; ?>')">
                        <div class="landing">
                                ...
                                <div class="u-ui-padding-x-large landing__cover-wrapper">
                                        ...
                                        <div class="logo__inner">
                                            <?php if (isset($infor_devices->path_logo)) { ?>
                                                <a class="" href="javascript:void(0)"><img
                                                            src="<?php echo '/' . $infor_devices->path_logo; ?>"
                                                            alt="logo_image" style="height: 100px;"></a>
                                            <?php } else { ?>
                                                <a class="" href="javascript:void(0)"><img
                                                            src="/webroot/images/logo.png" alt="logo image"></a>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div class="c-spacer--xx-large c-spacer"></div>
                                    ...
                                    <div class="redirect">
                                        ...
                                        <div class="redirect-wrapper" style="max-width: 280px !important;">
                                            <div class="m-text--desc "
                                                 style="text-align: center;color: red; word-wrap: break-word;">
                                            ...
                                            <div class="c-cell">
                                                <form class="form-validation" style="width: 100%" name="login"
                                                      ...
                                                      method="post">
                                                    <input style="width: 100%" type="submit" value="Connect now"
                                                           class="btn btn-success br-2 mr-5 block /">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="redirect">
                                        ...
                                        <div class="redirect-wrapper" style="max-width: 250px !important;">
                                            ...
                                            <div class="c-cell">
                                                <form class="form-validation" style="width: 100%" name="login"
                                                      id="login"
                                                      action="<?php echo $infor_devices->link_login_only; ?>"
                                                      method="post" onSubmit="return doLogin()">
                                                    <input type="hidden" name="dst"
                                                           value="<?php echo $infor_devices->link_orig; ?>"/>
                                                    <input type="hidden" name="popup" value="true"/>
                ...
                <div class="landing">
                    ...
                    <div class="landing__cover landing__cover--main landing__cover--flexible">
                        <div class="u-ui-padding-x-large landing__cover-wrapper">
                            <div class="landing__cover-content u-color-white">
                                ...
                                <div class="discount">
                                    ...
                                    <a class="redirect__discount" href="#modal_discount"
                                ...
                                <div class="redirect">
                                    <?php if ($infor_devices->hidden_connect == 1) { ?>
                                        <a class="redirect__normal"
                                           href="<?php echo $infor_devices->auth_target; ?>">Connect now
                                            -Slow</a>
                                    <?php } ?>
                                </div>
                            </div>
                        ...
                        <div class="u-ui-padding-x-large landing__cover-wrapper"
                            ...
                            <div class="u-ui-padding-x-large landing__cover-wrapper">
                                <?php } ?>
                                <div class="c-text--social c-text--parent c-text--center c-text">Our social
                                    profiles
                                </div>
                                <ul class="icons mbl">
                                    ...
                                    <li class="googleplus"><a href="" target="_blank"><i
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="c-spacer--x-large c-spacer"></div>
                            <form action="#" name="register_form" class="register_form" id="register_form"
                                  method="post">
                                <p><input type="text" id="_reg_full_name" name="name" value="" class="txt_input"
                                          placeholder="Họ và tên"></p>
                                <input style="display: none;" name="campaign_group_id" type="text"
                                       value="<?php echo isset($id_campaign) ? $id_campaign : ''; ?>"/>
                                <p><input type="text" id="_reg_full_" name="birthday" value=""
                                          class="txt_input datetime_birthday" placeholder="Ngày sinh"></p>
                                <p><input type="text" id="_reg_telephone" name="phone" value=""
                                          class="txt_input" placeholder="Số điện thoại"></p>
                                <p><input type="text" id="_reg_address" name="address" value=""
                                          class="txt_input" placeholder="Địa chỉ"></p>
                                <input type="hidden" name="device_id" value="<?php echo $infor_devices->id; ?>">
                                <input type="hidden" name="user_id"
                                       value="<?php echo $infor_devices->user_id; ?>">
                ...
                <div class="landing__cover landing__cover--main landing__cover--flexible">
                    <div class="u-ui-padding-x-large landing__cover-wrapper">
                        <div class="landing__cover-content u-color-white">
                            <div class="c-spacer--xx-large c-spacer"></div>
                            <div class="logo">
                                <div class="logo__inner"><?php if (isset($infor_devices->path_logo)) { ?>
                                        <a class="" href="javascript:void(0)"><img
                                                    src="<?php echo '/' . $infor_devices->path_logo; ?>"
                                                    style="height: 100px;" alt="logo image"></a>
                                    <?php } else { ?>
                                        <a class="" href="javascript:void(0)"><img
                                                    src="/webroot/images/logo.png" alt="logo image"></a>
                                    <?php } ?>
                    ...
                    <div class="u-ui-padding-x-large landing__cover-wrapper" style="padding-top: 0px !important;">
                        ...
                        <div class="u-ui-padding-x-large landing__cover-wrapper">
                            ...
                            <ul class="icons mbl">
                                ...
                                <li class="googleplus"><a href="" target="_blank"><i class="fa fa-google-plus"></i></a>
                                </li>
    ...
    <div id="modal_discount" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="c-spacer--x-large c-spacer"></div>
                    <form class="form-validation" style="width: 100%" name="login_popup" id="info_mirkotic"
                          action="#" method="post">
                        <input type="hidden" name="dst" value="<?php echo $infor_devices->link_orig; ?>"/>
                        <input type="hidden" name="popup" value="true"/>
                        <input style="display: none;" name="username" type="text" value="wifimedia"/>
                        ...
                        <p><input type="text" id="_reg_full_" name="birthday" value=""
                                  class="txt_input datetime_birthday" placeholder="Ngày sinh"></p>
                        <p><input type="text" id="_reg_telephone" name="phone" value="" class="txt_input"
                                ...
                                <div class="u-ui-padding-x-large landing__cover-wrapper">
                                    ...
                                    <div class="redirect">
                                        ...
                                        <div class="redirect-wrapper" style="max-width: 250px !important;">
                                            ...
                                            <div class="c-cell">
                                                <form class="form-validation" style="width: 100%" name="login"
                                                      id="login" action="<?php echo $infor_devices->link_login_only; ?>"
                                                      method="post" onSubmit="return doLogin()">
                                                    <input type="hidden" name="dst"
                                                           value="<?php echo $infor_devices->link_orig; ?>"/>
                                                    <input type="hidden" name="popup" value="true"/>
                    ...
                    <div class="landing__cover landing__cover--main landing__cover--flexible">
                        <div class="u-ui-padding-x-large landing__cover-wrapper">
                            <div class="landing__cover-content u-color-white">
                                ...
                                <div class="redirect">
                                    <?php if ($infor_devices->hidden_connect == 1) { ?>
                                        <a class="redirect__normal" href="<?php echo $infor_devices->auth_target; ?>">Connect
                                            now - Slow</a>
                                    <?php } ?>
                                </div>
                            </div>
                        ...
                        <div class="u-ui-padding-x-large landing__cover-wrapper" style="padding-top: 0px !important;">
                            ...
                            <div class="u-ui-padding-x-large landing__cover-wrapper">
                                <?php } ?>
                                <div class="c-text--social c-text--parent c-text--center c-text">Our social profiles
                                </div>
                                <ul class="icons mbl">
                                    ...
                                    <div class="u-ui-padding-x-large landing__cover-wrapper">
                                        ...
                                        <div class="redirect">
                                            ...
                                            <div class="redirect-wrapper" style="max-width: 250px !important;">
                                                ...
                                                <div class=" c-spacer"></div>
                                                <label class="c-input--default c-input--password c-input"
                                                       for="user_password">
                                                    <div class="c-input__content js-input-content">
                                                        <input type="password" name="password" id="user_password"
                                                               class="c-input__value " placeholder="Nhập mật khẩu">
                                                    </div>
                                                </label>
                                                <div class="c-cell">
                                        ...
                                        <div class="landing__cover-content u-color-white">
                                            <div class="logo">
                                                ...
                                                <div class="logo__inner">
                                                    ...
                                                    <?php } else { ?>
                                                        <a class="" href="javascript:void(0);"><img
                                                                    src="/webroot/images/logo-go-wi-fi-free-fast.png"
                                                                    alt="crm.wifimedia.vn"></a>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="redirect">
                                                <a class="btn _face"
                                                   href="<?php echo $infor_devices->auth_target; ?>"><i
                                    ...
                                    <div class="u-ui-padding-x-large landing__cover-wrapper">
                                        ...
                                        <div class="logo">
                                            <div class="logo__inner">
                                                ...
                                                <?php } else { ?>
                                                    <a class="" href="javascript:void(0)"><img
                                                                src="/webroot/images/logo.png" alt="logo"></a>
                                                <?php } ?>
                                            </div>
                                        </div>
                                        <div class="c-spacer--xx-large c-spacer"></div>
                                            ...
                                            <div class="redirect-wrapper" style="max-width: 250px !important;">
                                                ...
                                                <div class="c-cell">
                                                    <form class="form-validation" style="width: 100%" name="login"
                                                        ...
                                                        <input style="display: none;" name="password" type="password"
                                                               value="wifimedia"/>
                                                        <input style="display: none;" name="password_check"
                                                               id="password_check" type="text"
                                                               value="<?php echo $passrord; ?>"/>
                                                        <button style="width: 100%" type="submit"
                                                                class="btn btn-success mb-10 br-2 mr-5 block /">Connect
                                                            now
                                                        </button>
                                                    </form>
                                                </div>
                ...
                <div class="section" id="section1">
                    <?php foreach ($list_path as $k => $vl) { ?>
                        <div class="slide" id="slide<?php echo $k + 1; ?>"
                            ...
                            <div class="landing">
                                <div class="landing__cover-overlay"></div>
                                <div class="landing__cover landing__cover--main landing__cover--flexible set_center_<?php echo $k + 1; ?>"
                                     id="check_<?php echo $k + 1; ?>">
                                    <div class="u-ui-padding-x-large landing__cover-wrapper">
                                        <div class="landing__cover-content u-color-white">
                                            <div class="logo">
                                                <div class="logo__inner">
                                            ...
                                            <div class="redirect">
                                                <form class="form-validation" style="width: 100%" name="login"
                                                    ...
                                                    <input style="display: none;" name="password" type="password"
                                                           value="wifimedia"/>
                                                    <button class="btn btn-primary btn-success mb-10 br-2 _face"><i
                                                                class="fa fa-facebook"></i>Login with Facebook
                                                    </button>
                                                    <button class="btn btn-primary btn-success mb-10 br-2 _goog"><i
                                                                class="fa fa-google-plus"></i>Login with Google
                                                    </button>
                                                    <button class="btn btn-primary btn-success mb-10 br-2 _wifi"><i
                                                                class="fa fa-wifi"></i>Connect now - Slow
                                                    </button>
                                                </form>
                                            </div>
                                        </div>
