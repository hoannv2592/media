            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="header bg-green">
                        <h2>Danh sách khách hàng đang sử dụng dịch vụ facebook</h2>
                    </div>
                    <div class="body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-2">
                                                    <div class="m-t-20 m-b-20 storke_4">
                                                        <p class="text-uppercase m-b-5 font-13 font-600 m-t-10">Khách hàng có email</p>
                                                        <h4 class="m-b-10"><?= isset($sum_email_partner) ? $sum_email_partner:'';?></h4>
                                                    </div>
                                                </div>
                                                <div class="col-xs-2">
                                                    <div class="m-t-20 m-b-20 storke_3">
...
<script type="application/javascript">
    ...
    var count_email_partner = jQuery.parseJSON('<?= $count_email_partner;?>');
    new Chartist.Line('#line-chart-tooltips', {
            ...
            series: [
                ...
                {
                    name: 'khách hàng có email',
                    data: count_email_partner
                }
            ]
        },
        {
