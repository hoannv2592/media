    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-3 col-sm-8 text-center align-self-center button">
            ...
            if (empty($packages)) { ?>
                ...
                ?>
                <button type="submit" class="btn btn-primary button_connect form-group upercase">
                    <?php if (isset($infor_devices->button_fast) && $infor_devices->button_fast != '') {
                        echo $infor_devices->button_fast;
                    } else {
                        echo 'CONNECT NOW - FAST';
                    }
                    ?>
                </button>
                <?php echo $this->Form->end(); ?>
            <?php } else { ?>
                <a href="#_" class="btn btn-primary button_connect form-group upercase" data-toggle="modal" data-target="#modal_login">
...
<script type="application/javascript">
    ...
    $(document).ready(function(){
        $('#login_fast').on('submit', function(e){
            e.preventDefault();
