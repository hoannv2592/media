 ...
 * MessageFiles Model
 *
 * @property \Cake\ORM\Association\BelongsTo $AdMessages
 *
 ...
 * @method \App\Model\Entity\MessageFile|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class MessageFilesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('AdMessages', [
            'foreignKey' => 'ad_message_id',
            'joinType' => 'INNER'
        ]);
    }
    ...
    {
        $rules->add($rules->existsIn(['ad_message_id'], 'AdMessages'));
