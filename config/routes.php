...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('view_qc/:id /: auth/ :partner_id', ['controller' => 'Devices', 'action' => 'viewQc'], array(
        'pass' => array('id'),
        'id' => '[0-9]{4,}',
        'auth' => '[0-9a-z:A-Z]+',
        'partner_id' => '[0-9a-z:A-Z]+'
    ));
...
//            'flag_id' => '[0-9]+'
    ...
    $routes->connect('/get_product/:phone', array('controller' => 'Messages', 'action' => 'getDataswitchboard'),
        array(
//            'pass' => array('id', 'flag_id'),
//            'id' => '[0-9a-z:A-Z%]+',
//            'flag_id' => '[0-9]+'
    ...
    $routes->connect('/back_end_check/:id/:flag_id', array('controller' => 'Reports', 'action' => 'checkAddNewDevice'),
        array(
//            'pass' => array('id', 'flag_id'),
//            'id' => '[0-9a-z:A-Z%]+',
//            'flag_id' => '[0-9]+'
