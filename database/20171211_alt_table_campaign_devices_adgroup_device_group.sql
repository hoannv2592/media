...
ALTER TABLE devices  ADD `tile_congratulations_return` varchar(500) DEFAULT NULL;
ALTER TABLE adgroups  ADD `tile_congratulations_return` varchar(500) DEFAULT NULL;
ALTER TABLE device_groups  ADD `tile_congratulations_return` varchar(500) DEFAULT NULL;
ALTER TABLE campaign_groups  ADD `tile_congratulations_return` varchar(500) DEFAULT NULL;
